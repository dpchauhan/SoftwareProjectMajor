                    ...
                    <div id="signup-box-white">
                        <div id="signup-box-head" class="text-center">
                            ...
                            <div id="signup_success">
                                <i class="fa fa-check-circle"> </i> Your account has been successfully created.
                            </div>
                        </div>
                        ...
                        <div id="signup-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lastname" class="form-control" id="signup-last-name" placeholder="Enter your last name" pattern="[a-zA-Z]+['-]*[a-zA-Z]+" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="confirmpassword" class="form-control" id="signup-confirm-password" placeholder="Re-enter your password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{6,24}$"required>
                                    <span toggle="#password-field" class="field-icon toggle-signup-password-confirm"><img src="images/pre-login/eye.png"></span>
                                </div>
                                <div class="form-group">
                                    <button type="submit" name="signup" class="btn btn-gneral btn-purple" id="signup-btn">Sign Up</button>
                                </div>
<!--
                                <div id="signup-btn">
                                    <a class="btn btn-gneral btn-purple" href="#" title="Download" role="button" data-toggle="modal" data-target="#verifyemailModal">Sign Up</a>
                                </div>
-->
                            </form>
