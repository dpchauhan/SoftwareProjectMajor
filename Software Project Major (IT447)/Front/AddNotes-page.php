...
<!--                                <textarea class="form-control" id="addnote-note-displaypicture" rows="4" placeholder="Upload a picture"></textarea>-->
                                <label class="custom-file-upload">
                                    <input type="file" name="note_display_pic" id="note-dp-file-upload" onchange="validate_add_note_display_pic()"  />
...
<!--                                <textarea class="form-control" id="addnote-note-uploadnote" rows="4" placeholder="Upload your notes"></textarea>-->
                                <label class="custom-file-upload">
                                    <input type="file" name="note_pdf[]" id="note-pdf-file-upload" onchange="validate_add_note_attachment()" required multiple/>
...
<!--                                <textarea class="form-control" id="addnote-note-preview" rows="4" placeholder="Upload a file"></textarea>-->
                                <label class="custom-file-upload">
                                    <input type="file" name="note_preview_pdf" onchange="validate_add_note_preview()" id="note-preview-file-upload" />
    ...
    $(document).ready(function() {
       $('input[type="radio"]').click(function() {
           if($(this).attr('id') == 'selling-paid') {
                ...
                if(document.getElementById("note-preview-file-upload").value == "") {
