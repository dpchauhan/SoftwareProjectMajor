                        ...
                        <div id="forgot-pass-form">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="forgot_pass_email" class="form-control" id="forgot-password-email" placeholder="Enter your email" required>
                                </div>

                                <div id="forgot-pass-submit-btn">
                                    <button type="submit" name="forgot_pass_submit" class="btn btn-gneral btn-purple">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
