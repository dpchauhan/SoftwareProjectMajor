...
<?php
    ...
    if(isset($_GET['download_note_id'])) {
        ...
        $downloaded_note_id = $row['downloaded_note_id'];
        ...
        $download_note_sql_2 = "SELECT * FROM seller_notes_attachment WHERE attachment_note_id = $downloaded_note_id";
        $download_note_result_2 = query($download_note_sql_2);
        confirmQuery($download_note_result_2);
        $row_2 = fetch_array($download_note_result_2);
        $download_path_name = $row['attached_file_name'];
        
        download_attachment($download_path,$download_path_name);
