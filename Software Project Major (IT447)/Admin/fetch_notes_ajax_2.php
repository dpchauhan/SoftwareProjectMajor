...
<?php
        ...
        <td>
            <div class='action-img'>
                <div class='view-downloaded-buyer-icon'>
                    <a href='MemberDetails.php?member_id=$buyer_id'><img src='images/Dashboard/eye.png' alt='View' class='img-responsive'></a>
                </div>
            </div>
        </td>
        <td>$seller</td>
            ...
            <div class='action-img'>
                <div class='action-downloaded-note dropleft'>
                    ...
                    <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                        <a class='dropdown-item' href='DownloadedNotes.php?admin_download_note=$note_path&admin_download_note_name=$note_path_name'>Download Notes</a>
            ...
            <div class='action-img'>
                <div class='action-rejected-note dropleft'>
                    ...
                    <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                        ...
                        <a class='dropdown-item' href='RejectedNotes.php?admin_download_note=$path&admin_download_note_name=$path_name'>Download Notes</a>
                        <a class='dropdown-item' href='NoteDetails-admin.php?note_id=$note_id'>View More Details</a>
                    </div>
                </div>
            </div>
    ...
    if(isset($_POST['admin_members_data'])) {
        ...
        <td><a href='NotesUnderReview.php?member_inreview_note=$member_id'>$member_inreview_count</a></td>
        <td><a href='PublishedNotes.php?member_published_note=$member_id'>$member_published_count</a></td>
        <td><a href='DownloadedNotes.php?member_downloaded_note=$member_id'>$downloads_count</a></td>
        <td><a href='DownloadedNotes.php?member_downloaded_note=$member_id'>$$total_expense</a></td>
        <td>$$total_earning</td>
        <td>
            <div class='action-img'>
                <div class='action-members dropleft'>
                    ...
                    <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                        <a class='dropdown-item' href='MemberDetails.php?member_id=$member_id'>View More Details</a>
        ...
        <td>
            <div class='action-img'>
                <div class='action-member-detail-note dropleft'>
                    ...
                    <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                        <a class='dropdown-item' href='MemberDetails.php?member_id=$the_member_id&admin_download_note=$note_path&admin_download_note_name=$note_path_name'>Download Notes</a>
                    </div>
