        ...
        <div class="container">
            <div class="row dashboard-info-row text-center">
                <div class="col-sm-4 col-md-4">
                    <div class="dashboard-info-card">
                        <div class="dashboard-info-card-head">
                            <h3><a href="NotesUnderReview.php"><?php echo $in_review_count; ?></a></h3>
                        </div>
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="dashboard-info-card">
                        <div class="dashboard-info-card-head">
                            <h3><a href="DownloadedNotes.php"><?php echo $downloaded_notes_count; ?></a></h3>
                        </div>
                        <div class="dashboard-info-card-p">
