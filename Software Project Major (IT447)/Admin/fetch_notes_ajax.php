                    ...
                    <div class='action-img'>
                        <div class='published-note-action dropleft'>
                            ...
                            <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                                <a class='dropdown-item' href='Dashboard-admin.php?admin_download_note=$note_path&admin_download_note_name=$note_path_name'>Download Notes</a>
        ...
        <td>
            <div class='action-img'>
                <div class='action-notes-under-review dropleft'>
                    ...
                    <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                        <a class='dropdown-item' href='NoteDetails-admin.php?note_id=$note_id'>View More Details</a>
                        <a class='dropdown-item' href='NotesUnderReview.php?admin_download_note=$note_path&admin_download_note_name=$note_path_name'>Download Notes</a>
                    </div>
                </div>
            </div>
        </td>
        ...
        <td>
            <div class='action-img'>
                <div class='action-published-note dropleft'>
                    ...
                    <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                        <a class='dropdown-item' href='PublishedNotes.php?admin_download_note=$path&admin_download_note_name=$path_name'>Download Notes</a>
                        <a class='dropdown-item' href='NoteDetails-admin.php?note_id=$note_id'>View More Details</a>
                        <a role='button' class='dropdown-item unpublish_note' id='$note_id' rel='$note_title'>Unpublish</a>
                    </div>
                </div>
